...
export const MetaData = {
  ...
  defaultTitle: "KryptoKite - Cryptocurrency Tracker",
  defaultDescription:
    "KryptoKite is a cryptocurrency tracker that allows you to track the latest prices of your favorite crypto currencies.",
