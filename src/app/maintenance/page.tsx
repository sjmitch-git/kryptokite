const MaintenancePage = () => {
  return (
    <article className="flex flex-col items-center justify-center h-full p-6 text-light space-y-8 bg-gradient-to-b from-primary-dark from-20% to-primary-light to-90%">
